...
Assim, para resolver os casos de uso, podemos analisar uma estrutura sequencial que mostra a forma que as classes se relacionam. No caso do caso de uso 'Controlar Barco Solar', essa é a forma que foi estruturada para seu funcionamento.
